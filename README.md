...
3. 성공한 실행의 `Artifacts`에서 `Bigimong-AR-v0.11-debug`를 내려받습니다.
4. 압축을 풀어 `Bigimong-AR-v0.11-debug.apk`를 ARCore 지원 Android 기기에 설치합니다.
...
게임 규칙은 `docs/GAME_SPEC_v0.4.md`, 캐릭터 번호는 `docs/CHARACTER_CATALOG_v0.7.md`, AR 기본 계약은 `docs/AR_BATTLE_SPEC_v0.8.md`, 최신 AR 구현 내용은 `docs/AR_IMPLEMENTATION_v0.11.md`를 확인하세요.
